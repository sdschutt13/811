...
d%<>%filter(anxietyD>0, anxietyR>0, enthD>0, enthR>0, pid>0)#clears out non-responses

d%<>%mutate(pid3pt = ifelse(d$pid%in%c(1, 2, 3), "Dem", "Rep"))#creates 3 point party id variable
d%<>%mutate(pid3pt = ifelse(d$pid%in%c(4),"Ind", pid3pt))#creates label for indep
